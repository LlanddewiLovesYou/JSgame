...
play() {
  ...
  setTimeout(() => this.dialog('Your puny matches are nothing to me!'), 3000)
  setTimeout(() => this.dialog('Foolish mortals! Prepare to meet ur Doooom!'), 3000)
...
victory(boolean) {
  ...
  if (this.points <= 0 && this.win === false) {
    ...
    setTimeout(() => this.dialogUp('Play Again? Click my headstone! I dare you!'), 5000)
    this.win = true
